...
public class Pasien {
    ...
    private String nama;
    private ArrayList<Konsultasi> riwayatKonsultasis;
    LocalDate tanggal;

    public Pasien(String noRekamMedis, String nama) {
        this.noRekamMedis = noRekamMedis;
        this.nama = nama;
        this.riwayatKonsultasis = new ArrayList<Konsultasi>();
    }
    ...
    public void tambahKonsultasi(LocalDate tanggal, Pegawai dokter, Pegawai perawat) {
        ...
        riwayatKonsultasis.add(konsultasi);
    }
    ...
    public String getInfo() {
        ...
        if (!riwayatKonsultasis.isEmpty()) {
            info += "Riwayat Konsultasi :\n";

            for(Konsultasi konsultasi : riwayatKonsultasis) {
